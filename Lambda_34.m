function res=Lambda_34(sqr_ro,sqr_w,l,h,tet_condition,step,end_xi)
    ro=sqrt(sqr_ro);
    w=sqrt(sqr_w);
    xi=(ro^2:step:end_xi)';
    X=set_x(xi,ro);
...
%TETA-----------------------------------    
    t11=roundn(((U/V1)-w-DV2),-13);
    t12=roundn((cos(psi))^2,-13);
    t1=t11*t12;
    
    t21=roundn((V1-w-DV2),-13);
    t22=roundn(sin(psi)^2,-13);
    t2=t21*t22;
    
    t31=-roundn((DV1/(2*V1)),-13);
    t32=roundn(sin(2*psi),-13);
    t3=t31*t32;
%---------------------------------------    
    F1=t1+t2+t3;
%V--------------------------------------        
    Om11=roundn((DV1/V1),-13);
    Om12=roundn(cos(2*psi),-13);
    Om1=Om11*Om12;
    
    Om21=roundn(((U/V1)-V1),-13);
    Om22=roundn(sin(2*psi),-13);
    Om2=Om21*Om22;
%---------------------------------------    
    F2=-((Om1+Om2)/2)*y(2);
%---------------------------------------
